# Design Thinking Course for Businesses — Learner Guide

**WSQ Course Code:** TGS-2026064719  |  **TSC:** Design Thinking Practices (DSN-ACE-3014-1.1)  |  **Conducted by:** Tertiary Infotech Academy Pte Ltd (UEN 201200696W)  |  **Version v15.0 · 10 August 2026**
...
- [Before You Start — Your Ed-Tools](#before-you-start--your-ed-tools)
- [How to Download Your Course Material](#how-to-download-your-course-material)
- [Topic 01 — Key Concepts & Principles of Design Thinking](#topic-01--key-concepts--principles-of-design-thinking)
  - [Activity 1 — Design a Vase — Reframing the Brief](#activity-1--design-a-vase--reframing-the-brief)
  - [Activity 2 — Design Thinking Readiness — Mindset & Culture Self-Assessment](#activity-2--design-thinking-readiness--mindset--culture-self-assessment)
- [Topic 02 — Applications of Design Thinking](#topic-02--applications-of-design-thinking)
  - [Activity 3 — Uncover Design Thinking Opportunities in Your Business](#activity-3--uncover-design-thinking-opportunities-in-your-business)
- [Topic 03 — Action Phases of Design Thinking](#topic-03--action-phases-of-design-thinking)
  - [Activity 4 — The Wallet Project — A Full Design Thinking Cycle](#activity-4--the-wallet-project--a-full-design-thinking-cycle)
- [Topic 04 — Methodologies and Visual Tools for Design Thinking](#topic-04--methodologies-and-visual-tools-for-design-thinking)
  - [Activity 5 — Empathy Map & Persona — The Gift-Giving Experience](#activity-5--empathy-map--persona--the-gift-giving-experience)
  - [Activity 6 — POV, How Might We & Brainstorming](#activity-6--pov-how-might-we--brainstorming)
  - [Activity 7 — Prototype, Test & Measure the Outcome](#activity-7--prototype-test--measure-the-outcome)
...
Ideation is where you concentrate on idea generation — going wide in terms of concepts and outcomes. Objective: translate problems into solutions by exploring a wide variety and large quantity of ideas, going beyond the obvious. It relies on creativity (combining rational thought with imagination), group synergy (building on each other's ideas) and the separation of divergent from convergent thinking. Active facilitation matters: create a curious, courageous and concentrated atmosphere.
...
A completed four-quadrant empathy map and a one-page persona for your partner.   (Ed-tools: Design Thinking Toolkit — Empathy Map & Persona canvases (alfredang.github.io/designthinking).)
